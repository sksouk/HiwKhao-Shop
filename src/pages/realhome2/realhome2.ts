...
@IonicPage()
@Component({
  selector: 'page-realhome2',
  templateUrl: 'realhome2.html',
})
export class Realhome2Page { 
  ...
  ionViewDidEnter(){
    ...
    loader.present().then(() => {
      this.http.post('http://hoctiengviet.net/food_order/ionicphp/fetch_order4.php', data, options)
        .map(res => res.json())
        .subscribe(res => {
