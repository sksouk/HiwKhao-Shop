...
@IonicPage()
@Component({
  selector: 'page-realhome4',
  templateUrl: 'realhome4.html',
})
export class Realhome4Page { 
...
logout(){
  ...
  ionViewDidEnter(){
    ...
    loader.present().then(() => {
      this.http.post('http://hoctiengviet.net/food_order/ionicphp/fetch_order6.php', data, options)
        .map(res => res.json())
        .subscribe(res => {
